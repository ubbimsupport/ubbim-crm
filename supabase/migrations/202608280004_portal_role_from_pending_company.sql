-- Hosted companion to portal_role_from_app_metadata. Same function body so
-- public signup can inherit user/contractor from a pending company email
-- when Auth Admin app_metadata is not present.
